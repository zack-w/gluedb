class ProcessAudits
  def self.execute(active_start, active_end, term_start, term_end, out_directory)
    active_audits = Policy.find_active_and_unterminated_in_range(active_start, active_end)
    term_audits = Policy.find_terminated_in_range(term_start, term_end)
